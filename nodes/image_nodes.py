...
# ============================================================
# ComfyUI-MyDemoPlugin / nodes/image_nodes.py
# 包含两个自定义节点：
#   1. ImageBrightnessNode  —— 图像亮度 / 对比度调整
#   2. ImageInvertNode      —— 图像颜色反转
#
# ComfyUI 中图像格式：torch.Tensor，形状为 [B, H, W, C]
#   B = batch size, H = 高度, W = 宽度, C = 通道数(RGB=3)
